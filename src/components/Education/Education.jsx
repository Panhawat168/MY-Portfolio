  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-20">
        <h2 className="text-4xl font-bold text-white">{t('education.title')}</h2>
              ...
              >
                <div className="bg-gray-900 border border-white rounded-2xl shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] p-6 hover:scale-[1.02] transition-transform duration-300">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-white">{t(`${key}.degree`)}</h3>
                      <p className="text-sm text-gray-300">{t(`${key}.school`)}</p>
                      <p className="text-xs text-gray-500">{t(`${key}.date`)}</p>
                    </div>
                  </div>

                  <p className="text-md text-gray-300 text-justify ">{t(`${key}.desc`)}</p>
                </div>
              </div>
            </div>
          );
